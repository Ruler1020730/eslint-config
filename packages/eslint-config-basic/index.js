...
module.exports = {
  ...
  overrides: [
    ...
    },
    {
      ...
      rules: {
        ...
        "no-unused-expressions": "off",
        "no-unused-vars": "off",
        "ruler/no-cjs-exports": "off",
        "ruler/no-ts-export-equal": "off",
  ...
  rules: {
    ...
    // ruler
    "ruler/no-import-node-modules-by-path": "error",
    "ruler/if-newline": "error",
    "ruler/import-dedupe": "error",
    "ruler/top-level-function": "error",
    // 'ruler/prefer-inline-type-import': 'error',
  },
};
